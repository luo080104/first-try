...
  @sort	String	必须	排序方式，默认为0，0-综合排序，1-商品上架时间从高到低，2-销量从高到低，3-领券量从高到低，4-佣金比例从高到低，5-价格（券后价）从高到低，6-价格（券后价）从低到高

"""
from dtkApi.apiRequest import Request


class SuperDiscountGoodsReq(Request):
    url = 'goods/super-discount-goods'
    check_params = ['sort','pageId','pageSize']
    ...
    def setParams(self, sort,pageId, pageSize,cids=None):
